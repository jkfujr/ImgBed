...
const analyzerPath = path.join(repoRoot, 'test', 'analyze-lighthouse-report.mjs');
const reportJsonPath = path.resolve(process.cwd(), '.docs', 'localhost_5173-20260404T053631.json');
const latestReportPath = path.join(repoRoot, 'test', 'reports', 'lighthouse-analysis-latest.md');
